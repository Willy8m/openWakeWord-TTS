...
def main():
    ...
    parser.add_argument("--output_folder", required=True, help="Where .yaml config will be saved")
    parser.add_argument("--data_dir", required=True, help="Absolute path to data folder")
